...
public class Teste {
	...
	public static void main(String[] args) {
		...
		for(int i = 0;i<dadosT.getVar_xi().length;i++) {
			texto += ( "|" + discreto.format(dadosT.getVar_xi()[i])+" | "+discreto.format(dadosT.getVar_fi()[i])+" | "+discreto.format(dadosT.getVar_Fi()[i])+" | "+nf.format(dadosT.getVar_fr()[i])+"% | "+nf.format(dadosT.getVar_Fr()[i])
		...
		texto += ("Mediana = " + dadosT.getMediana() + "\n");
		texto += ("\nModa = ");
